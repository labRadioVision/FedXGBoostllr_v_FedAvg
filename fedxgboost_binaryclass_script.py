...
num_classes = 2 # number of classes (only 2)
...
for c, (x_train, y_train) in enumerate(datasets):  # for each client
    ...
    y_xgb_trees_out.append(y_train) # true labels now categorical
...
# Validation data (y_valid contains the validation labels)
...
params_cnn = (num_clients, filter_size, trees_client, filters, 2)
